...
type Server struct {
	opts            microservice.ServerOptions
...
// NewServer creates a new TCP microservice server.
func NewServer(opts microservice.ServerOptions) *Server {
	return &Server{
		opts:            opts,
...
func (s *Server) handleConn(conn net.Conn) {
	...
	// Increase buffer for larger messages
